...
import com.crypto.trade.repository.CoinRepository;
...
public class CoinServiceImp implements CoinService {
    ...
    public String getCoinDetail(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setMarketCapChange24h(marketData.get("market_cap_change_24h").get("usd").asDouble());
    ...
    @Override
    public String get50CoinsByMarketCapRank() throws Exception {
